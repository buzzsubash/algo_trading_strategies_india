# account level sl, re-attempt on execution range cancellation, telegram integration
...
def get_trade_price(order_id):
    ...
    while a < 10:
        try:
            ...
            a += 1
            try:
                telegram_bot_sendtext('kiteconnect api error, unable to open tradebook get_trade_price module, retrying....')
            except:
                pass
    return trade_price
...
def get_trade_quantity(order_id):
    ...
    while a < 10:
        try:
            ...
            a += 1
            try:
                telegram_bot_sendtext('kiteconnect api error, unable to open tradebook get_trade_quantity module, retrying....')
            except:
                pass
    return qty
...
def get_order_status(order_id):
    ...
    while a < 30:
        try:
            ...
            a += 1
            try:
                telegram_bot_sendtext('kiteconnect api error, unable to open tradebook get_order_status module, retrying....')
            except:
                pass
...
def universal_exit():
    ...
    try:
        telegram_bot_sendtext('universal exit hit')
    except:
        pass
